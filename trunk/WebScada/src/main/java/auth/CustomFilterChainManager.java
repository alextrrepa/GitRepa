...
public class CustomFilterChainManager extends DefaultFilterChainManager {
    private Map<String, String> filterChainDifinitionMap = null;
    private String loginUrl;
    private String successUrl;
    private String unauthorizedUrl;

    public CustomFilterChainManager() {
        System.out.println("Init custom filterchainmanager");
        setFilters(new LinkedHashMap<String, Filter>());
        setFilterChains(new LinkedHashMap<String, NamedFilterList>());
        addDefaultFilters(false);
    }

    public Map<String, String> getFilterChainDifinitionMap() {
        return filterChainDifinitionMap;
    }

    public void setFilterChainDifinitionMap(Map<String, String> filterChainDifinitionMap) {
        this.filterChainDifinitionMap = filterChainDifinitionMap;
    }
    ...
    public void setDefaultFilterChainDefinitions(String definitions) {
        ...
        setFilterChainDifinitionMap(section);
    }
    ...
    public void init() {
        ...
        Map<String, String> chains = getFilterChainDifinitionMap();
