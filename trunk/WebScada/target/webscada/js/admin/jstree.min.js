    ...
    if (!a.jstree) {
        ...
        j.setAttribute("role", "treeitem"), k = i.createElement("I"), k.className = "jstree-icon jstree-ocl", k.setAttribute("role", "presentation"), j.appendChild(k), k = i.createElement("A"), k.className = "jstree-anchor", k.setAttribute("href", "#"), k.setAttribute("tabindex", "-1"), l = i.createElement("I"), l.className = "jstree-icon jstree-themeicon", l.setAttribute("role", "presentation"), k.appendChild(l), j.appendChild(k), k = l = null, a.jstree = {
            ...
            plugin: function (b, c) {
                ...
                this.trigger("ru.scada.entities", {
                    nodes: h,
                    parent: f
                ...
                if (null !== this.element) {
                    ...
                    var f = null, g = {
                        ...
                        if (null !== this.element) {
                            ...
                            b.add.length && (this._data.core.selected = this._data.core.selected.concat(b.add)), this.trigger("ru.scada.entities", {
                                nodes: b.dpc,
                                parent: b.par
                ...
                f.a_attr.id || (f.a_attr.id = f.id + "_anchor"), b.setAttribute("aria-selected", !!f.state.selected), b.setAttribute("aria-level", f.parents.length),
                ...
                for (h = this.get_node(d), i = [], i.push(d), i = i.concat(h.children_d), this.trigger("ru.scada.entities", {
                    nodes: i,
                    parent: c.id
                ...
                for (m = this.get_node(p), c && c.state && c.state.loaded === !1 && (m.state.loaded = !1), l = [], l.push(p), l = l.concat(m.children_d), this.trigger("ru.scada.entities", {
                    nodes: l,
                    parent: r.id
                ...
                return (b = this.get_node(b)) ? this.settings.core.check_callback === !1 ? (this._data.core.last_error = {
                    ...
                    blur: a.proxy(function () {
                        var c = h.children(".jstree-rename-input"), e = c.val(), f = this.settings.core.force_text, k;
        ...
        m.className = "jstree-icon jstree-checkbox", m.setAttribute("role", "presentation"), a.jstree.defaults.checkbox = {
            ...
            this.bind = function () {
                ...
                }, this)), this.settings.checkbox.tie_selection || this.element.on("ru.scada.entities.jstree", a.proxy(function (a, b) {
                ...
                }, this)), (-1 !== this.settings.checkbox.cascade.indexOf("up") || -1 !== this.settings.checkbox.cascade.indexOf("down")) && this.element.on("ru.scada.entities.jstree", a.proxy(function (b, c) {
            ...
            this.bind = function () {
                c.bind.call(this), this.element.on("ru.scada.entities.jstree", a.proxy(function (a, b) {
        ...
        a.jstree.defaults.state = {
            ...
            this.init = function (a, c) {
                ...
                this.element.on("ru.scada.entities.jstree", a.proxy(function (a, c) {
