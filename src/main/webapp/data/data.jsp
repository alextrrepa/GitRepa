...
<head>
    ...
    <link href="../static/css/data/data.css" rel="stylesheet" type="text/css"/>
    <link href="../static/css/data/jquery.datetimepicker.css" rel="stylesheet" type="text/css"/>

    <script src="../static/js/jquery-1.11.3.min.js"></script>
    <script src="../static/js/data/data.js"></script>
    <script src="../static/js/data/jquery.datetimepicker.js"></script>
    <script src="../static/js/data/pushy.js"></script>
</head>
<body>
